      seqfile = erlangeri.paml      * sequence data filename
     treefile = tree.txt      * tree structure file name
      outfile = codeml-BS-2-neumanni1-erlangericlade           * main result file name
    ...
    CodonFreq = 2  * 0:1/61 each, 1:F1X4, 2:F3X4, 3:codon table
        ...
        ndata = 10706 * number of gene alignments to be analysed
